...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            loadingBar.setTitle("Google");
            loadingBar.setMessage("Signing into Your Google Account");
            ...
            if (result.isSuccess())
            {
                ...
                Toast.makeText(this, "Receiving auth result", Toast.LENGTH_SHORT).show();
            }
            else
            {
//                Toast.makeText(this, "Can't get Auth result.", Toast.LENGTH_SHORT).show();
    ...
    private void UserLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            Toast.makeText(this, "Pleas type in your email", Toast.LENGTH_LONG).show();
        }
        else if (TextUtils.isEmpty(password)) {
            Toast.makeText(this, "Please type in your password", Toast.LENGTH_LONG).show();
        }
        else {
